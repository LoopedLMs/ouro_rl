...
def plot_distance_curves(
    ...
    output_path = output_dir / f"gsm8k_latent_distances_per_loop_steps{total_ut_steps}{samples_suffix}{logscale_suffix}.png"
...
def main():
    ...
    parser.add_argument(
        "--output-dir", type=Path, default=Path(__file__).parent / "outputs", help="Output directory for plots"
    )
